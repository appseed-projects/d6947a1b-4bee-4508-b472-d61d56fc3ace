...
- Timestamp: `2022-05-26 15:23`
- Build ID: `d6947a1b-4bee-4508-b472-d61d56fc3ace`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d6947a1b-4bee-4508-b472-d61d56fc3ace.git
$ cd d6947a1b-4bee-4508-b472-d61d56fc3ace
```
